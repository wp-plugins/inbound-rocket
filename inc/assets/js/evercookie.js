...
(function (window) {
 ...
 function idb() {
  ...
  var defaultOptionMap = {
    ...
    baseurl: ir_var.lib_path, // base url for php, flash and silverlight assets
    asseturi: '', // assets = .fla, .jar, etc, default is /assets
    phpuri: '', // php file path or route, default is /php
